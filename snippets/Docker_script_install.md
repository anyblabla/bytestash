...
Script d'installation automatisé pour Docker
...
```bash
# Page de wiki qui évoque ce script disponible à cette adresse : https://wiki.blablalinux.be/fr/docker-portainer-lxc-debian-proxmox
#!/bin/sh
set -e
