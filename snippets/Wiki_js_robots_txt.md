...
- Les liens sitemap.xml
- Les règles pour les robots de recherche
- Les règles pour les robots d'intelligence artificielles
...
# Allow ALL search engine robots to crawl the site.
User-agent: *
