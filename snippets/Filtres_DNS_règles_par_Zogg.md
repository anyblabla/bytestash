...
Filtres de blocage DNS pour les solutions de blocage telles que AdGuard Home, PiHole ou encore GoAway. Est fourni avec un ensemble de règles de filtrage personnalisées.
