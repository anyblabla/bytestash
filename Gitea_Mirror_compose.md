# Gitea Mirror compose

Fichier "docker-compose.yml" à utiliser pour déployer Gitea Mirror via Docker.
...
services:
  gitea-mirror:
    image: ghcr.io/raylabshq/gitea-mirror:v3.8.3
...
```plaintext
BETTER_AUTH_SECRET=wbbcc09MEKcsmaSjxz85VYGPQFs/yzDgzq8B+IKRKJs=
```
