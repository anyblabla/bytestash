...
Fichier "docker-compose.yml" à utiliser pour déployer Wekan via Docker.
...
services:
  ...
  wekan:
    ...
    environment:
      ...
      - ROOT_URL=https://wekan.blablalinux.be  #   <=== using only at same laptop/desktop where Wekan is installed
      #---------------------------------------------------------------
      # ==== EMAIL SETTINGS ====
      ...
      - MAIL_FROM=Notifications <noreply.wekan@mydomain.com>
